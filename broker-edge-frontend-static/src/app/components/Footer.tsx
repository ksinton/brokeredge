...
export default function Footer() {
    return (
            <div className="bg-gradient-to-b from-[#0e5423] to-[#0e461f] pt-4 flex h-[100px] md:h-[80px] bg-left-top flex justify-center text-white text-m fixed w-full bottom-0">
