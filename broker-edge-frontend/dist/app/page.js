...
function Home() {
    return (react_1.default.createElement("div", { className: "grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]" },
        react_1.default.createElement("main", { className: "flex flex-col gap-8 row-start-2 items-center sm:items-start" },
            ...
            react_1.default.createElement("ol", { className: "list-inside list-decimal text-sm text-center sm:text-left font-[family-name:var(--font-geist-mono)]" },
                react_1.default.createElement("li", { className: "mb-2" },
                    "Get started by editing",
                    " ",
                    react_1.default.createElement("code", { className: "bg-black/[.05] dark:bg-white/[.06] px-1 py-0.5 rounded font-semibold" }, "src/app/page.tsx"),
                    "."),
                react_1.default.createElement("li", null, "Save and see your changes instantly.")),
