...
export default function BrokerSignup({host}: SignupProps) {
    ...
    return (
        <div className="flex flex-col text-standard-text-color p-5">
            ...
            <h1 className={SiteSpecificStyles.standardHeading(host)}>Brokers Signup</h1>

            <div className="grid md:grid-cols-[auto_1fr] gap-0.5 md:gap-4 pb-2 md:pb-5">

                <div className="flex flex-col justify-center pb-0.5 md:pb-0">Brokerage Name</div>
                ...
                <div className="flex flex-col justify-center">Phone Number</div>
                <div className="form-right-col mb-3 md:mb-0">
                    <input
                        type="text"
