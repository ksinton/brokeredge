...
export default function Home() {
    ...
    const listingsData: listingInterface[] = [
        {
            title: "Fairfield Family Diner",
            description: `
      A cozy diner located in the heart of Fairfield, known for its homestyle cooking and loyal customer base.
      This family-owned establishment has been a cornerstone of the community for over 20 years, offering a warm and welcoming atmosphere to diners of all ages.
      Our menu features classic American comfort food made from scratch daily, with recipes passed down through generations.
      The business includes a fully equipped kitchen, spacious dining area, and ample parking.

      Located on a busy main street with high foot traffic, the diner has an established reputation for its exceptional food quality and friendly service.
      This is a turnkey opportunity with trained staff, a dedicated customer base, and a proven track record of consistent revenue.
      Expansion opportunities include extending hours, offering catering services, or enhancing the online ordering system.
    `,
            price: 350000,
        },
        {
  ...
  return (
      <>
          <div className="bg-gradient-to-t from-mobile-header-dark-background to-mobile-header-background md:bg-[url('/buy-a-business-in-fairfield-iowa.jpg')] mx-0 md:mx-4 flex h-[87px] md:h-[104px] bg-left-bottom">

              <div className="space-y-2 md:space-y-4 px-5 pb-5 mt-3 relative w-full max-w-[430px] md:max-w-none">
                  ...
                  <div className="flex space-x-4 text-forground-form-field">
                      ...
                      <select className="p-1 rounded w-full max-w-[200px]">
