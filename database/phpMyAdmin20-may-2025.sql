...
--
-- Host: mariadb:3306
-- Generation Time: May 21, 2025 at 03:17 AM
...
(4, 0, 'kimSinton@gmail.com', 'dragon99dragon99', 1747593499, 1747627916);
...
(2, 'a small amount (part time for up to a year)'),
(3, 'moderate (full time for several months or part time for several years)'),
(4, 'full (some team members will stay working full time for at least a year)');
...
--
ALTER TABLE `reason_for_selling`
  MODIFY `id` tinyint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
